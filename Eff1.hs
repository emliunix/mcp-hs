...
{- The following is the version of the non-determinism code
   explained in the Haskell 2013 paper.
   We defined the Alternative/MonadPlus in terms of choose.

   In the Haskell 2015 paper, we introduced the Nondet effect
   that more directly corresponds to Alternative/MonadPlus.
   So, now we define choose in terms of Alternative/MonadPlus.
...
exc1 :: Member NdetEff r => Eff r Int
...
makeChoice = makeChoiceA -- for backwards compatibility
